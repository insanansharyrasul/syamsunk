...
android {
    ...
    defaultConfig {
        ...
        // ponytail: strip Play Services / AppCompat locales, keep English only (AAB already splits by language)
...
dependencies {
    ...
    // ponytail: required transitively by activity-compose registerForActivityResult (lint InvalidFragmentVersionForActivityResult)
